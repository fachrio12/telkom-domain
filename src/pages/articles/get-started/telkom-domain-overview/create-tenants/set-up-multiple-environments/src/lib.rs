...
pub struct SetUpMultipleEnvironments {}

pub enum Msg {}

impl Component for SetUpMultipleEnvironments {
    type Message = Msg;
    type Properties = ();
    ...
    fn view(&self, _ctx: &Context<Self>) -> Html {
        html! {
            <>
                ...
                <h1 class="uk-heading-small uk-margin-medium-bottom">{ "Set Up Multiple Environments" }</h1>
